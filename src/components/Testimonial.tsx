        ...
        <div className='container pt-16 pb-16 grid-cols-2'>
            ...
            <div className='grid lg:grid-cols-[300px,1fr] gap-4'>
                ...
                <div className='text-center flex flex-col items-center gap-1'>
                    ...
                    alt='dp'
                    />
                    <h2 className='text-gray-500 font-black text-[20px]'>Suhila Ahmed</h2>
                    <p>CED & Founder Invision</p>
                    <Image className='inline-block py-2'
                    src="/quotes-1024.webp"
                    width={30}
                    height={30}
                    alt='quotes'
                    />
                ...
                <div className='bg-red-600 bg-[url(/shopping-07.jpg)] bg-cover h-[500px] rounded-2xl
